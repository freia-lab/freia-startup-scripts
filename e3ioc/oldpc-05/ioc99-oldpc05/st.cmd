...
dbLoadRecords("$(linstat_DB)linStatHost.db","IOC=Ctrl-oldpc05")
...
dbLoadRecords("$(linstat_DB)linStatNIC.db","IOC=Ctrl-oldpc05,NIC=enp3s2")
dbLoadRecords("$(linstat_DB)linStatFS.db","P=Ctrl-oldpc05:disk-root,DIR=/")
dbLoadRecords("$(linstat_DB)linStatFS.db","P=Ctrl-oldpc05:disk-bootefi,DIR=/boot/efi")
