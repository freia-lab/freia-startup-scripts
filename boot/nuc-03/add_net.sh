#!/bin/bash
device1=enx00249b488e29
device2=enx00249b488e2a
host=`hostname`
...
# nmcli connection add type ethernet con-name PLC1 ifname $device1 ip4 192.168.1.117/24
...
# nmcli connection add type ethernet con-name NESSA ifname $device2 ip4 192.168.21.117/24
